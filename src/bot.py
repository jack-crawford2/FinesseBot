...
class FinesseBot(BaseAgent):
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        if(self.index == 0):
            ...
            self.renderer.draw_string_2d(5, 180, 1, 1, "v: " + f'{my_car.physics.velocity:.1f}', self.renderer.black())
            ...
            self.renderer.draw_string_2d(255, 180, 1, 1, "v: " + f'{my_car.physics.velocity:.1f}', self.renderer.black())
