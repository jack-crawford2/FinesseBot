...
class FinesseBot(BaseAgent):
    ...
    def get_output(self, packet: GameTickPacket) -> SimpleControllerState:
        ...
        if(self.index == 0):
            ...
            self.renderer.draw_string_2d(5, 150, 1, 1, str(math.atan2(ball_location.y - car_location.y, ball_location.x - self.car_location.x)), self.renderer.black())
            ...
            self.renderer.draw_string_2d(255, 150, 1, 1, str(math.atan2(ball_location.y - car_location.y, ball_location.x - self.car_location.x)), self.renderer.black())
